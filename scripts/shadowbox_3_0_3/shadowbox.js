...
S.options = {
     ...
     * @type    {String}
     */
    handleUnsupported: "link",                                                 //-----------CHANGED
 ...
 * - description: A reference to the innerHTML of the nextSibling innerHTML
 * 
...
S.makeObject = function(link, options) {
    var obj = {
        ...
        link:           link,
        //Daza: This will provide the description of the content provided by the sibling element: 1_29_2011 //
        description:    link.parentNode.children[1].innerHTML       
    };
...
S.iframe = function(obj, id) {
    ...
    var platter = get("sb-platter");                                                            /*Daza: Modify any instance "platter" from instance of "overlay" :1_22_2011 */
    this.height = obj.height ? parseInt(obj.height, 10) : platter.offsetHeight;
    this.width = obj.width ? parseInt(obj.width, 10) : platter.offsetWidth;
}
...
function buildBars(callback) {
    ...
    //Daza: Added this to get the description "info" into the shadowbox
    get("sb-description-inner").innerHTML = obj.description || "";                              
...
function showBars(callback) {
    var titleInner = get("sb-title-inner"),
        ...
        descriptionInner = get("sb-description-inner"),
        duration = 0.35;
    ...
    if (titleInner.innerHTML != "")
        ...
        animate(descriptionInner, "marginTop", 0, duration);
...
function hideBars(anim, callback) {
    var title = get("sb-title"),
        info = get("sb-info"),
        description = get("sb-description"),
    ...
    animate(descriptionInner, "marginTop", descriptionHeight, duration);
...
function setDimensions(height, width) {
    var bodyInner = get("sb-body-inner"),
        ...
        maxHeight = platter.offsetHeight,                                          
        maxWidth = platter.offsetWidth,
    ...
    '<div id="sb-content">'+
        ...
        '<div id="sb-t-d">'+
            ...
            '<div id="sb-description">' +
            	'<div id="sb-description-inner"></div>' +
            '</div>' +
        '</div>' +
    '</div>' +
'</div>';
...
K.init = function() {
    ...
    //Daza : added to define platter : 1_22_2011
    platter = get("sb-platter");                 
